...
>
> [!TIP]
> This project has the [Maven Build Cache Extension](/docs/maven-build-cache.md) available to speed up builds. The cache is disabled by default - add `-Dmaven.build.cache.enabled=true` to your Maven commands to enable it.
